...
silent only
cd ~/projects/SOK/Dokumentacja/OpisWymagań
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 dokument.tex
badd +0 preambula_pakiety.tex
badd +0 preambula_ustawienia.tex
badd +0 tresc_dokumentu.tex
args dokument.tex preambula_pakiety.tex preambula_ustawienia.tex tresc_dokumentu.tex
edit dokument.tex
...
silent! normal! zE
let s:l = 125 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
normal! 014|
tabedit preambula_pakiety.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
normal! 0
tabedit preambula_ustawienia.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
normal! 0
tabedit tresc_dokumentu.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
