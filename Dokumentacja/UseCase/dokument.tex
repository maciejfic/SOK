\documentclass[12pt]{article}
    ...
    \title{Specyfikacja ról i przypadków użycia dla Systemu Obsługi Konferencji naukowo-dydaktycznych instytutu Sterowania i Elektroniki Przemysłowej Politechniki Warszawskiej }
    \author{Piotr Błądek}
